...
class TfidfFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        with open('../saved_data/kaggle/vec.pkl', 'wb') as vo:
            pickle.dump(vec, vo)
        ...
        with open("../saved_data/kaggle/" + outfilename_simtfidf, "wb") as outfile:
    ...
    def read(self):
        ...
        with open("../saved_data/new/" + filename_simtfidf, "rb") as infile:
